...
dofile("./src/datastructures/linked_list/singly_linked_list/singly_linked_list.lua")    -- singly_linked_list
...
dofile("./tests/test_singly_linked_list/test_singly_linked_list.lua")                   -- test_singly_linked_list
